      ...
      >
        ...
        <div className="w-full max-w-6xl flex flex-col gap-8 px-4 sm:px-8 md:flex-row md:justify-around py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-base sm:text-lg">Pune, Maharashtra, India</p>
            </div>
          </div>

          {/* Mail Us */}
          <div className="flex items-center gap-4">
            <a href="mailto:tanpureroshan1119gmail.com">
            ...
            <div>
              ...
              <a
                href="mailto:tanpureroshan1119@gmail.com"
                className="text-base sm:text-lg"
              >
                tanpureroshan1119@gmail.com
              </a>
            </div>
          </div>
        </div>
        ...
        >
          <p className="text-center text-sm">
            ...
            <span className="text-blue-500">Roshan Tanpure</span>
          </p>
          <div className="flex gap-4 mt-2 md:mt-0">
            ...
            <a
              href="https://github.com/roshan7965"
              className="hover:text-blue-500 transition"
            >
              Source Code
            </a>
