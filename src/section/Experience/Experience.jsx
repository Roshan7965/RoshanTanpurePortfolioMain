...
const TimelineDemo = ({ mode }) => {
  const data = [
    {
      title: "Web Developer",
      subtitle: "Indian Meteorological Department-Goverment",
      period: "july 2024 – Dec 2024",
      icon: "work",
      content:
        "Developed and maintained scalable web dhasboard using React.js,  and Tailwind CSS, ensuring responsive and optimized UI/UX. Implemented server-side rendering (SSR) and SEO optimization in React.js to enhance website performance and discoverability.",
    },
    {
      title: "Frontend Developer Intern",
      subtitle: "CNC WEBWORLDTechnologies Pvt Ltd ",
      period: "Jan 2024 – Mar 2024",
      icon: "work",
      content:
        "Engineered web applications with javaScript, Tailwind CSS, and, improving performance efficiency by 15%. Collaborated with cross-functional teams, reducing feature deployment cycles by 10%.",
    },
    {
      title: "BE in Computer Science",
      subtitle: "Bharati Vidyapeeth's College of Engineering,Pune",
      period: "2021 – 2025",
      icon: "education",
      content:
    ...
    },
    {
      ...
      subtitle: "Nivruttirao Dhas Madyamik Vidyalaya ",
      period: "2019 – 2021",
      icon: "education",
      content:
