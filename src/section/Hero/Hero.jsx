...
import Roshan from "../../../public/portfoliopic.png";
import { BsSunFill } from "react-icons/bs";
import { BsFillMoonStarsFill } from "react-icons/bs";
import leetcodelight from "../../assets/leetcodelight.png";
...
import CV from "../../assets/Roshan_Tanpure_CV.pdf";
    ...
    <>
      ...
      >
        ...
        <div className="relative md:mt-20 mt-6 lg:order-2 lg:mr-10 lg:flex lg:justify-end ">
          <img
            src={Roshan}
            alt="Roshan Tanpure || Full-Stack Developer"
        ...
        <div className="text-center lg:text-left m-5 md:mt-48 lg:ml-10">
          ...
          <div className="flex justify-center lg:justify-start items-center gap-5 mt-4">
            <a
              href="https://leetcode.com/u/Roshan_7965/"
              target="_blank"
            >
              <img
                src={mode === "light" ? leetcodelight : leetcodedark}
                alt="Roshan Tanpure || Full-Stack Developer"
            ...
            <a
              href="https://www.linkedin.com/in/roshan-tanpure-63b97b234/"
              target="_blank"
            >
              <img
            ...
            <a href="https://github.com/roshan7965" target="_blank">
              <img
